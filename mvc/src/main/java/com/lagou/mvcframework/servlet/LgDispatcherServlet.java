...
import com.lagou.mvcframework.annotation.*;
...
public class LgDispatcherServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        // 扫描相关的类，扫描注释  得到各个类的全限定类名
        doScan(this.properties.getProperty("scanPackage"));
        ...
        // 构造一个HandleMapping处理器映射，将配置好的url和Method建立映射关系
        initHandlerMapping();
    ...
    private void initHandlerMapping() {
        ...
        for(Map.Entry<String,Object> entry: ioc.entrySet()) {
            ...
            if(aClass.isAnnotationPresent(Security.class)) {
                ...
                securityNames = annotation.value();
            }
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if(method.isAnnotationPresent(Security.class)) {
                    Security annotation1 = method.getAnnotation(Security.class);
                    securityNames = annotation1.value();
                    handler.setSecurity(securityNames);
                }
